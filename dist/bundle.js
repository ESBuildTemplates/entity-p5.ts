...
${this.children.map((child, index2) => `${child.schema(indentation, depth + 1, index2)}`).join("\n")}` : ""}`;
  ...
  var Animation = class extends Time {
    ...
    onDraw() {
      var _a, _b;
      (_b = (_a = this.settings).onDraw) == null ? void 0 : _b.call(_a, map(this.settings.easing((frameCount - this.startedAt) / this.settings.duration), 0, 1, this.settings.from, this.settings.to));
    }
    onUpdate() {
      var _a, _b;
